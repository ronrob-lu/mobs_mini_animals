--[[
  mobs_mini_animals: Giraffe Entity Definition
  
  AI Behavior Rationale:
  Tall serene herbivore towering over savannas and acacia groves.
  
  Grass-Eating Justification:
  GRAZER. Giraffes browse tall foliage and acacia leaves, as well as high grass.
...
mobs:register_mob("mobs_mini_animals:giraffe", {
	type = "animal",
	pathfinding = 1,
	passive = false,
	damage = 3,
...
-- Spawning configuration: Spawns in savannas
...
mobs:register_egg("mobs_mini_animals:giraffe", S("Giraffe"), "inv_animal-giraffe.png")
