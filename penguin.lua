--[[
  mobs_mini_animals: Penguin Entity Definition
  
  AI Behavior Rationale:
  Aquatic seabird waddling across icy shores and swimming gracefully underwater.
  
  Grass-Eating Justification:
  NON-GRAZER. Penguins consume fish, krill, and squid, not pasture grass.
...
mobs:register_mob("mobs_mini_animals:penguin", {
	type = "animal",
	pathfinding = 1,
	passive = true,
	hp_min = 4,
...
-- Spawning configuration: Spawns on ice/snow near cold oceans
if not mobs.custom_spawn_animal then
	mobs:spawn({
		name = "mobs_mini_animals:penguin",
...
mobs:register_egg("mobs_mini_animals:penguin", S("Penguin"), "inv_animal-penguin.png")
