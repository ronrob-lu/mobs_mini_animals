--[[
  mobs_mini_animals: Dog Entity Definition
  
  AI Behavior Rationale:
  Friendly canine companion mob that wanders settlements and forests.
  
  Grass-Eating Justification:
  NON-GRAZER. Carnivore / omnivore.
...
mobs:register_mob("mobs_mini_animals:dog", {
	type = "animal",
	pathfinding = 1,
	passive = false,
	damage = 3,
	...
	reach = 1,
	pathfinding = 1,
	specific_attack = {"mobs_mini_animals:cat"},
...
-- Spawning configuration: Spawns in grassy forest biomes
if not mobs.custom_spawn_animal then
	mobs:spawn({
		name = "mobs_mini_animals:dog",
...
mobs:register_egg("mobs_mini_animals:dog", S("Dog"), "inv_animal-dog.png")
